    ...
    return (
        ...
        <form>
            ...
            <div class="flex justify-between fixed items-center bottom-0 px-3 py-2 rounded-lg bg-gray-50">
                <textarea id="chat" onChange={(e) => setMessage(e.target.value)} rows="1" cols="1000" class="block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Your message..."></textarea>
